          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="max-w-[250px]">
                <p>Visualiza la evolución temporal de tus métricas financieras principales:
                  <br/>• Ventas: Ingresos totales
                  <br/>• Gastos: Costos operativos
                  <br/>• Ganancias: Beneficio neto</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
    ...
    <div className="space-y-6">
      ...
      <Card className="p-4 bg-muted/50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium mb-1">Reporte Financiero</h3>
            <p className="text-sm text-muted-foreground">
              Esta sección proporciona una visión completa del rendimiento financiero, 
              incluyendo ventas totales, gastos operativos y ganancias netas. 
              Visualiza tendencias temporales y analiza el desglose por categorías para 
      ...
      <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="p-4 md:p-6 bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-950/20 dark:to-red-900/10 border-red-200/50">
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
        ...
        {/* Net Profit Card */}
        <Card className="p-4 md:p-6 bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-950/20 dark:to-green-900/10 border-green-200/50">
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="min-w-[100px]">Variación</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
